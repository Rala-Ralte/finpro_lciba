...
def main(args):
    ...
    # TODO: change these for another model
    # example:
    # https://github.com/YingWANGG/M2IB/blob/main/demo.ipynb
    ...
    # TODO: change data stuff
    # TSV: caption first, image url second
    df = pd.read_csv(
        args.data_path,
        sep="\t"
    )
    ...
    for text, image_path in tqdm(
        ...
        try:
            ...
            print(
                f"Unable to load image at {image_path}",
                flush=True
            )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        required=True,
        type=str,
        help="path to the image-text dataset"
    )
