...
class LxmertXLayer(nn.Module):
    def __init__(self, config, save_cams=False):
        ...
        # Separate module for vis→lang cross-attn (shares weights, separate attn storage)
        self.visual_attention_copy = LxmertCrossAttentionLayer(config, save_cams=save_cams)
